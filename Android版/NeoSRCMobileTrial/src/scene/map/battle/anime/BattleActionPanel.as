package scene.map.battle.anime
{
	...
	public class BattleActionPanel extends CSprite
	{
		...
		/**ユニットデータ*/
		private var _leftUnitData:UnitCharaData = null;
		private var _rightUnitData:UnitCharaData = null;
		...
		/**ユニットセット*/
		public function setUnit(leftUnitData:UnitCharaData, rightUnitData:UnitCharaData):void
		{
			if (_leftUnitImg != null)
			{
				_leftUnitImg.dispose();
			...
			_leftUnitData = leftUnitData;
			_rightUnitData = rightUnitData;
