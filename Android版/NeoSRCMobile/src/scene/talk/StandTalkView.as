package scene.talk
{
    ...
    public class StandTalkView extends TalkViewBase
    {
        ...
        override protected function playCommand(line:String, command:Array, param:Object):void
        {
            ...
            case "setstandimage": //
            case "setchara": //
                setStandCharaFunc(command, param);
                break;
            /**
               case "movemsg":
         ...
         * @param	param
         */
        protected function setStandCharaFunc(command:Array, param:Object):void
        {
            _moveFlg = true;
        ...
        protected function setCharaMoveFunc(command:Array, param:Object):void
        {
            ...
            {
                if (
                (_charaList[i].name != null && (_charaList[i].charaName === param.chara || _charaList[i].nickName === param.chara)) || //
                (_charaList[i].imgId != null && param.hasOwnProperty("id") && _charaList[i].imgId == param.id))
                {
        ...
        protected function removeChara(command:Array, param:Object):void
        {
            for (var i:int = 0; i < _charaList.length; i++)
            {
                if (_charaList[i].name === param.name || _charaList[i].nickName === param.name || (_charaList[i].imgId != null && param.hasOwnProperty("id") && _charaList[i].imgId == param.id))
                {
