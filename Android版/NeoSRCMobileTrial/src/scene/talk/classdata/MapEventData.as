package scene.talk.classdata
{
    ...
    public class MapEventData
    {
        ...
        // 制圧イベントセット
        public function setControlParam(label:String, param:Object):void
        {
            var i:int = 0;
            _param = param;
            _label = label;
        ...
        public function judgeBaseControllParam(param:Object):Boolean
        {
            var flg:Boolean = true;
        ...
        public function judgeBattleParam(param:Object):Boolean
        {
             ...
             */
            if ((getJudgeName(param, 1, 1) && getJudgeName(param, 2, 2)) || (getJudgeName(param, 1, 2) && getJudgeName(param, 2, 1)) || (getJudgeName(param, 1, 1) && getSideName(param.side2) === _param.unit2) || (getJudgeName(param, 1, 2) && getSideName(param.side2) === _param.unit1) || (getJudgeName(param, 2, 2) && getSideName(param.side1) === _param.unit1) || (getJudgeName(param, 2, 1) && getSideName(param.side1) === _param.unit2) || (getSideName(param.side1) === _param.unit1 && getSideName(param.side2) === _param.unit2) || (getSideName(param.side1) === _param.unit2 && getSideName(param.side2) === _param.unit1))
            {
                flg = true;
            }
            return flg;
        ...
        public function getJudgeName(param:Object, side:int, target:int):Boolean
        {
            ...
            if (param[unitname] === _param[targetname] || param[nickname] === _param[targetname])
            {
                return true;
            }
