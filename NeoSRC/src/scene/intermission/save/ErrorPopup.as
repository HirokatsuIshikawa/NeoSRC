package scene.intermission.save
{
	 ...
	 * @author ishikawa
	 */
	public class ErrorPopup extends CSprite
	{
		/**暗幕画像*/
		...
		/**コンストラクタ*/
		public function ErrorPopup(msg:String, btnMsg:String = "OK")
		{
			super();
			//暗幕設定
			...
			//メッセージ設定
			_text = new CTextArea(16, 0xFFFFFF, 0x0, TextFormatAlign.CENTER);
