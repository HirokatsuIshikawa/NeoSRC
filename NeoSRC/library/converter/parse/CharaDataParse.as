package converter.parse
{
	...
	public class CharaDataParse
	{
		...
		public static const PARAM_LIST:Array = ["name", "nickName", "Cost", "exp", "money", "MaxLv", "HP", "FP", "ATK", "CAP", "TEC", "DEF", "MND", "SPD", "MOV", "terrain"];
		public static const PARAM_P_LIST:Array = ["名前", "愛称", "コスト", "経験値", "資金", "最大レベル", "ＨＰ", "ＦＰ", "攻撃", "潜在", "技術", "防御", "精神", "敏捷", "移動", "地形"];
