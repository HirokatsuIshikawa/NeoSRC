...
package code.org.coderepos.text.encoding.converters
{
    ...
    import code.org.coderepos.text.encoding.writers.IUnicodeWriter;

    public class UTF8Converter implements IUnicodeConverter
    {
        private var _unicodeWriter:IUnicodeWriter;

        public function UTF8Converter(unicodeWriter:IUnicodeWriter)
        {
